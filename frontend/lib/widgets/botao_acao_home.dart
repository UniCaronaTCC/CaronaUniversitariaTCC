...
class BotaoAcaoHome extends StatelessWidget { // Cria um botão grande reutilizável para a tela inicial
  ...
  Widget build(BuildContext context) {
    return SizedBox( // Controla o tamanho do botão
      ...
      child: ElevatedButton.icon( // Cria botão com ícone e texto
